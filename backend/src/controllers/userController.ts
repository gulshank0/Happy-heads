...
export class UserController {
  async createUser(req: Request, res: Response) {
    try {
      const { name, email, age, bio, phone, gender, college, googleId, url, location, year, major, interests, avatar } = req.body;
      ...
      const user = await prisma.user.create({
        data: { name, email, avatar, age: Number(age), bio, phone, college, gender, googleId, url, location, year, major, interests, createdAt: new Date(), updatedAt: new Date() }
      });
  ...
  async updateUser(req: Request, res: Response) {
    try {
      ...
      const { name, email, avatar, age, phone, bio, college, gender, url, location, year, major, interests } = req.body;
