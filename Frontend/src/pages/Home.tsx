    ...
    <div>
      <div className="min-h-screen bg-black text-white">
        ...
        <div className="flex">
          {/* Sidebar */}
          <div
            className={`fixed lg:static inset-y-0 left-0 z-40 w-64 backdrop-blur-md bg-white/5 border-r border-white/10 transform transition-transform lg:transform-none ${sidebarOpen ? "translate-x-0" : "-translate-x-full"}`}
          >
          ...
          <div className="flex-1 p-4 lg:p-8">
            ...
            {activeSection === "post" && (
              <div className="space-y-8">
                <h1 className="text-3xl font-bold text-white mb-8 flex items-center">
                  ...
                  <span className="text-blue-400">Update Profile Gallery</span>
                </h1>
                ...
                <div className="backdrop-blur-md bg-white/5 border border-white/10 rounded-xl p-6 mb-6">
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/60 text-sm">
                        Upload images to your profile to showcase your
                  ...
                  <div className="flex items-start space-x-2 text-white/50 text-sm">
                    ...
                    <p>
                      These images will appear on your profile gallery and help
                      potential matches get to know you better. They won't
            ...
            {/* Matches Section */}
            {activeSection === "matches" && <Matching />}

            {/* Messages Section */}
            {activeSection === "messages" && <Messenger />}
                          ...
                          <div className="space-y-3">
                            ...
                            <label className="flex items-center justify-between">
                              <div>
                                ...
                                <p className="text-white/60 text-sm">
                                  Show your approximate location to others
                                </p>
                              </div>
                              <button className="relative inline-flex h-6 w-11 items-center rounded-full bg-blue-500">
                                <span className="inline-block h-4 w-4 transform rounded-full bg-white translate-x-6" />
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="space-y-3">
                            {[
                              ...
                              {
                                label: "New Matches",
                                desc: "Get notified when you have a new match",
                                enabled: true,
                              },
                              {
                                label: "Profile Likes",
                                desc: "Get notified when someone likes your profile",
                                enabled: false,
                              },
                              {
                                label: "Post Comments",
                              ...
                              {
                                label: "Post Likes",
                                desc: "Get notified when someone likes your posts",
                                enabled: false,
                              },
